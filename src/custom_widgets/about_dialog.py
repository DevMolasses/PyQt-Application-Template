...
class AboutDialog(QDialog):
    ...
    def _create_widgets(self):
        ...
        self._title = QLabel("Application Title")
        _font = QFont()
        _font.setBold(True)
        ...
        self._logo = QLabel()
        self._logo.setPixmap(QPixmap(".\\resources\\application_icon.svg"))
    ...
    def _get_author(self) -> str:
        """Retrieve the __author__ attribute of the calling class.

        Returns
        -------
        str
            Contents of the __author__ attribute of the calling class. If the
            attribute doesn't exist, default is "Unknown".

        """
        try:
            return self._get_caller_module().__author__
    ...
    def _get_overview(self) -> str:
        ...
        -------
        txt : str
            String with the overview information.
        ...
        txt = (
            ...
            "text-align: center;'>"
            f"<p><strong>Author:</strong> {self._get_author()}</p>"
            f"<p><strong>Version:</strong> {self._get_version()}</p>"
            "</div>"
        )
        return txt
    ...
    def _get_version(self):
        """Retrieve the __version__ attribute of the calling class.

        Returns
        -------
        str
            Contents of the __version__ attribute of the calling class. If the
            attribute doesn't exist, default is None.

        """
        try:
            return self._get_caller_module().__version__
        except AttributeError:
            return None
